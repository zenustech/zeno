...
if (NOT WIN32)
    ...
    set(zen_LIBRARY ${zen_INSTALL_DIR}/usr/lib/zensession.dll)
endif()

message("zen_INCLUDE_DIR=${zen_INCLUDE_DIR}")
if (NOT TARGET zen)
    add_library(zen INTERFACE IMPORTED)
    set_target_properties(zen PROPERTIES IMPORTED_LOCATION ${zen_LIBRARY})
