...
namespace {
	...
	//struct divide_weight_functor {
	//	void operator()(openvdb::CombineArgs<openvdb::Vec3s, openvdb::Int32>& args) {
	//		if (args.bIsActive()) {
	//			if (args.b() != 0) {
	//				args.setResult(args.a() / float(args.b()));
	//				args.setResultIsActive(true);
	//			}
	//			else {
	//				printf("active count but value==0 error\n");
	//				exit(-1);
	//			}
	//		}
	//		else {
	//			if (args.aIsActive()) {
	//				printf("weight!=0 but velocity modified error\n");
	//				exit(-1);
	//			}
	//		}
	//	}
	...
	//struct add_extrapolated_velocity_functor {
	//	void operator()(openvdb::CombineArgs<openvdb::Vec3s, openvdb::Vec3s>& args) {
	//		if (args.aIsActive()) {
	...
	//			}
	//			else {
	//				printf("extrapolated voxel on originally valid voxel, error\n");
	//				exit(-1);
	//			}
	//		}
	//		else {
