...
struct FLIP_vdb {
	...
	openvdb::points::PointDataGrid::Ptr get_particles() const { return m_particles; }
	openvdb::FloatGrid::Ptr get_snapshot_liquid_sdf() const { return m_liquid_sdf_snapshot; }
	openvdb::Vec3fGrid::Ptr get_snapshot_velocity() const { return m_velocity_snapshot; }
	void set_boundary_volume(openvdb::FloatGrid::Ptr in_boundary_fill_kill_volume) { m_boundary_fill_kill_volume = in_boundary_fill_kill_volume; }
...
static void Advect(float dt, float dx, openvdb::points::PointDataGrid::Ptr particles, openvdb::Vec3fGrid::Ptr velocity,
...
static void particle_to_grid_collect_style(
	...
	float dx);
static void calculate_face_weights(
...
private:
	void initialize_attribute_descriptor() {
		...
		m_position_attribute_descriptor = openvdb::points::AttributeSet::Descriptor::create(pnamepair);
	...
	*/
	...
	//position attribute is with respect to voxel center with range(-0.5,0.5)
	...
	openvdb::FloatGrid::Ptr m_rhsgrid;
