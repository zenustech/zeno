...
void foreach_1x1x1(Pol const &pol, Grid &grid, F const &func) const {
...
template <class Pol, class Grid, class F>
void foreach_2x2x2(Pol const &pol, Grid &grid, F const &func) const {
    return grid->foreach(pol, [&] (Quint3 coor1, auto &leaf) {
        ...
        ndrange_for(policy::Serial{}, Quint(0), Quint(7), [&] (Quint coor2, auto &value) {
            if (xleaf && yleaf) {
