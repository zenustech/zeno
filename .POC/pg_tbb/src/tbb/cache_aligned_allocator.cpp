...
#if _WIN32||_WIN64
#define MALLOCLIB_NAME "pg_tbbmalloc" DEBUG_SUFFIX ".dll"
#elif __APPLE__
#define MALLOCLIB_NAME "pg_tbbmalloc" DEBUG_SUFFIX ".dll"	//.dylib
#elif __linux__
#define MALLOCLIB_NAME "pg_tbbmalloc" DEBUG_SUFFIX  ".dll"	//__TBB_STRING(.so.TBB_COMPATIBLE_INTERFACE_VERSION)
#elif __FreeBSD__ || __sun
#define MALLOCLIB_NAME "pg_tbbmalloc" DEBUG_SUFFIX ".dll"	//.so
#else
#error Unknown OS
#endif
