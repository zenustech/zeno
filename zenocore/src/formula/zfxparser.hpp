...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_ASSIGNTO = 281,          // ASSIGNTO
    TOKEN_IF = 282,                // IF
    TOKEN_ELSE = 283,              // ELSE
    TOKEN_FOR = 284,               // FOR
    TOKEN_WHILE = 285,             // WHILE
    TOKEN_AUTOINC = 286,           // AUTOINC
    TOKEN_AUTODEC = 287,           // AUTODEC
    TOKEN_LSQBRACKET = 288,        // LSQBRACKET
    TOKEN_RSQBRACKET = 289,        // RSQBRACKET
    TOKEN_ADDASSIGN = 290,         // ADDASSIGN
    TOKEN_MULASSIGN = 291,         // MULASSIGN
    TOKEN_SUBASSIGN = 292,         // SUBASSIGN
    TOKEN_DIVASSIGN = 293,         // DIVASSIGN
    TOKEN_LESSTHAN = 294,          // LESSTHAN
    TOKEN_LESSEQUAL = 295,         // LESSEQUAL
    TOKEN_GREATTHAN = 296,         // GREATTHAN
    TOKEN_GREATEQUAL = 297,        // GREATEQUAL
    TOKEN_RETURN = 298,            // RETURN
    TOKEN_CONTINUE = 299,          // CONTINUE
    TOKEN_BREAK = 300,             // BREAK
    TOKEN_TYPE = 301,              // TYPE
    TOKEN_ATTRAT = 302,            // ATTRAT
    TOKEN_FOREACH = 303,           // FOREACH
    TOKEN_DO = 304,                // DO
    TOKEN_EQUALTO = 305,           // EQUALTO
    TOKEN_NOTEQUAL = 306,          // NOTEQUAL
    TOKEN_OR = 307,                // OR
    TOKEN_AND = 308,               // AND
    TOKEN_NOT = 309,               // NOT
    TOKEN_ADD = 310,               // ADD
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_ASSIGNTO = 26,                         // ASSIGNTO
        S_IF = 27,                               // IF
        S_ELSE = 28,                             // ELSE
        S_FOR = 29,                              // FOR
        S_WHILE = 30,                            // WHILE
        S_AUTOINC = 31,                          // AUTOINC
        S_AUTODEC = 32,                          // AUTODEC
        S_LSQBRACKET = 33,                       // LSQBRACKET
        S_RSQBRACKET = 34,                       // RSQBRACKET
        S_ADDASSIGN = 35,                        // ADDASSIGN
        S_MULASSIGN = 36,                        // MULASSIGN
        S_SUBASSIGN = 37,                        // SUBASSIGN
        S_DIVASSIGN = 38,                        // DIVASSIGN
        S_LESSTHAN = 39,                         // LESSTHAN
        S_LESSEQUAL = 40,                        // LESSEQUAL
        S_GREATTHAN = 41,                        // GREATTHAN
        S_GREATEQUAL = 42,                       // GREATEQUAL
        S_RETURN = 43,                           // RETURN
        S_CONTINUE = 44,                         // CONTINUE
        S_BREAK = 45,                            // BREAK
        S_TYPE = 46,                             // TYPE
        S_ATTRAT = 47,                           // ATTRAT
        S_FOREACH = 48,                          // FOREACH
        S_DO = 49,                               // DO
        S_EQUALTO = 50,                          // EQUALTO
        S_NOTEQUAL = 51,                         // NOTEQUAL
        S_OR = 52,                               // OR
        S_AND = 53,                              // AND
        S_NOT = 54,                              // NOT
        S_ADD = 55,                              // ADD
        ...
        S_68_zfx_program = 68,                   // zfx-program
        S_69_multi_statements = 69,              // multi-statements
        S_70_general_statement = 70,             // general-statement
        S_71_array_or_exp = 71,                  // array-or-exp
        S_72_assign_op = 72,                     // assign-op
        S_73_code_block = 73,                    // code-block
        S_74_bool_stmt = 74,                     // bool-stmt
        S_75_assign_statement = 75,              // assign-statement
        S_76_jump_statement = 76,                // jump-statement
        S_arrcontent = 77,                       // arrcontent
        S_arrcontents = 78,                      // arrcontents
        S_79_array_stmt = 79,                    // array-stmt
        S_80_array_mark = 80,                    // array-mark
        S_81_only_declare = 81,                  // only-declare
        S_82_declare_statement = 82,             // declare-statement
        S_83_ifelse_statement = 83,              // ifelse-statement
        S_84_if_statement = 84,                  // if-statement
        S_85_for_begin = 85,                     // for-begin
        S_86_for_condition = 86,                 // for-condition
        S_87_for_step = 87,                      // for-step
        S_88_foreach_step = 88,                  // foreach-step
        S_89_loop_statement = 89,                // loop-statement
        S_90_compare_op = 90,                    // compare-op
        S_91_exp_statement = 91,                 // exp-statement
        S_orexp = 92,                            // orexp
        S_andexp = 93,                           // andexp
        S_compareexp = 94,                       // compareexp
        S_addsubexp = 95,                        // addsubexp
        S_factor = 96,                           // factor
        S_zenvar = 97,                           // zenvar
        S_funcargs = 98,                         // funcargs
        S_99_func_content = 99,                  // func-content
        S_term = 100                             // term
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT ((token::TOKEN_RPAREN <= tok && tok <= token::TOKEN_IDENTIFIER)
                   || (token::TOKEN_LITERAL <= tok && tok <= token::TOKEN_NOT)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_ASSIGNTO (string v, location_type l)
      {
        return symbol_type (token::TOKEN_ASSIGNTO, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_ASSIGNTO (const string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_ASSIGNTO, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ELSE (string v, location_type l)
      {
      ...
      static
      symbol_type
      make_ELSE (const string& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_LESSTHAN (string v, location_type l)
      {
      ...
      static
      symbol_type
      make_LESSTHAN (const string& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_LESSEQUAL (string v, location_type l)
      {
        return symbol_type (token::TOKEN_LESSEQUAL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_LESSEQUAL (const string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_LESSEQUAL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_GREATTHAN (string v, location_type l)
      {
        return symbol_type (token::TOKEN_GREATTHAN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_GREATTHAN (const string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_GREATTHAN, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_GREATEQUAL (string v, location_type l)
      {
        return symbol_type (token::TOKEN_GREATEQUAL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_GREATEQUAL (const string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_GREATEQUAL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_FOREACH (string v, location_type l)
      {
        return symbol_type (token::TOKEN_FOREACH, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_FOREACH (const string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_FOREACH, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_DO (string v, location_type l)
      {
      ...
      static
      symbol_type
      make_DO (const string& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_NOTEQUAL (string v, location_type l)
      {
        return symbol_type (token::TOKEN_NOTEQUAL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_NOTEQUAL (const string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_NOTEQUAL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_NOT (string v, location_type l)
      {
