...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOKEN_END
                   ...
                   || (token::TOKEN_RAND <= tok && tok <= token::TOKEN_NEG));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOKEN_SIN, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_SIN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_RAND, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_RAND, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
