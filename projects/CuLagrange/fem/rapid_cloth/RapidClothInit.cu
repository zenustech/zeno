...
ZENDEFNODE(MakeRapidClothSystem, {{"ZSParticles",
                              ...
                              {gParamType_Int, "spmat_cps", "1000000"}, 
                              {gParamType_Int, "est_num_cps", "100000"},
                              {gParamType_Int, "bvh_front_cps", "10000000"}, 
                              {gParamType_Int, "max_vert_cons", "32"}, 
                              ...
                              {gParamType_Float, "lcp_tol", "0.001"}, 
                              {gParamType_Int, "pn_iter_cap", "3"},
                              {gParamType_Int, "cg_iter_cap", "200"},
                              {gParamType_Int, "lcp_cap", "256"}, 
                              {gParamType_Float, "gravity", "-9.8"},
                              {gParamType_Int, "collision_iters", "512"}, 
                              {gParamType_Float, "delta", "1"}, 
                              {gParamType_Float, "edge_violation_ratio", "1.1"}, 
                              {gParamType_Bool, "enable_SL", "1"}, 
                              {gParamType_Float, "stepping_limit", "0.9"},  
                              {gParamType_Float, "term_thresh", "1e-4"}, 
                              {gParamType_Float, "BC_stiffness", "1000"}, 
                              {gParamType_Bool, "enable_excl_edges", "0"}, 
                              {gParamType_Float, "repulsion_coef", "0"}, 
                              {gParamType_Float, "repulsion_range", "2"}, 
                              {gParamType_Float, "sync_dist_thresh", "1e-2"}, 
                              {gParamType_Bool, "enable_degenerated_dist" , "1"} , 
                              {gParamType_Bool, "enable_dist_constraint", "1"}, 
                              {gParamType_Bool, "enable_friction", "0"}, 
                              {gParamType_Float, "cloth_fric_coef", "0.1"}, 
                              {gParamType_Float, "boundary_fric_coef", "10.0"}},
                             {"ZSClothSystem"},
                             {},
                             {"FEM"}});
