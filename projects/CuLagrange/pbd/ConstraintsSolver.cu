...
ZENDEFNODE(XPBDSolve, {{{"zsparticles"},
                            ...
                            {gParamType_String,"ptag","x"},
                            {gParamType_String,"pptag","px"},
...
ZENDEFNODE(XPBDSolveSmooth, {{{"zsparticles"},
                                {"constraints"},
                                {gParamType_Float,"relaxation_strength","1"},
                                {gParamType_Int,"nm_smooth_iters","1"},
                                {gParamType_Int,"nm_substeps","1"},
                                {gParamType_Int,"substep_id","0"},
                                {gParamType_Bool,"add_repulsion_force","0"},
                                {gParamType_Float,"boundary_velocity_scale","1"},
                                {gParamType_String,"ptag","x"},
                                {gParamType_String,"pptag","px"},
                                {gParamType_String,"dptag","dx"}
                            }, 
                            {{"zsparticles"}},
                            {},
                            {"PBD"}});
...
ZENDEFNODE(XPBDSolveSmoothAll, {{{"zsparticles"},
                                ...
                                {gParamType_String,"pptag","px"},
                                {gParamType_String,"dptag","dx"},
                                {gParamType_Float,"dt","1.0"},
                                {gParamType_Int,"nm_substeps","1"},
                                {gParamType_Int,"substep_id","0"},
                                {gParamType_Int,"iter_id","0"},
                                {gParamType_Bool,"update_vertex_position","1"},
                                {gParamType_Bool,"output_debug_inform","0"}
                            },
							{{"zsparticles"},{"constraints"}},
							{},
							{"PBD"}});
...
ZENDEFNODE(ProjectOntoSurface, {{{"zsparticles"},
                                ...
                                {gParamType_String,"ptag","x"},
                                {gParamType_String,"dptag","dx"},
                                {gParamType_String,"tptag","x"},
                                {gParamType_Bool,"update_target_mesh","1"},
                                {gParamType_Bool,"do_moton_ordering","1"},
                                {gParamType_Bool,"update_vertex_position","1"},
                                {gParamType_Float,"default_search_radius","0.0"}
                            },
                            {{"zsparticles"},{"target"}},
                            {},
                            {"PBD"}});
