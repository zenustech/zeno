...
({
    ...
    {gParamType_Bool, "deterministic", "0"},
    {gParamType_Float, "crease", "0"},
    {gParamType_Int, "smooth_iter", "0"},
    {gParamType_Bool, "quad_dominant", "0"},
    {gParamType_Bool, "intrinsic", "0"},
    {gParamType_Bool, "boundary", "0"},
    {gParamType_Float, "scale", "0"},
    {gParamType_Int, "vert_num", "0"},
    {gParamType_Int, "face_num", "0"},
    // {gParamType_Int, "knn", "0"},
