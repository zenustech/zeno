...
({
    ...
    {gParamType_String,"input_dir", "", Socket_Primitve, ReadPathEdit},
    {gParamType_String, "output_dir"},
    {gParamType_String,"tag", "", Socket_Primitve, ReadPathEdit},
    {"enum none union intersection difference", "operation", "none"},
    {gParamType_Float, "edge_length", "0"},
    {gParamType_Float, "epsilon", "0"},
    {gParamType_Float, "stop_energy", "0"},
    {gParamType_Bool, "skip_simplify", "0"},
    {gParamType_Bool, "no_binary", "0"},
    {gParamType_Bool, "no_color", "0"},
    {gParamType_Bool, "smooth_open_boundary", "0"},
    {gParamType_Bool, "export_raw", "0"},
    {gParamType_Bool, "manifold_surface", "0"},
    {gParamType_Bool, "coarsen", "0"},
    {gParamType_String,"csg", "", Socket_Primitve, ReadPathEdit},
    {gParamType_Bool, "disable_filtering", "0"},
    {gParamType_Bool, "use_floodfill", "0"},
    {gParamType_Bool, "use_general_wn", "0"},
    {gParamType_Bool, "use_input_for_wn", "0"},
    {gParamType_String,"bg_mesh", "", Socket_Primitve, ReadPathEdit}},
    {("prim")},
    {},
    {"primitive"},
});
