...
public:
    ...
    virtual bool active_int_cell(FieldHelper& field_helper, const IV& I) override { return field_helper.cell_type[field_helper.grid[I].idx] == Bow::EulerGas::CellType::GAS; };
