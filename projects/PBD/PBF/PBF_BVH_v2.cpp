#include "PBF_BVH_v2.h"
#include "SPHKernels.h"
// #include "../Utils/myPrint.h"
using namespace zeno;

void PBF_BVH_v2::preSolve()
{
    auto &pos = prim->verts;
...
void PBF_BVH_v2::boundaryHandling(vec3f & p)
{
...
inline float PBF_BVH_v2::computeScorr(const vec3f& distVec, float coeffDq, float coeffK, float h)
{
...
void PBF_BVH_v2::neighborSearch(std::shared_ptr<PrimitiveObject> prim)
{
    auto &pos = prim->verts;
...
void PBF_BVH_v2::buildNeighborList(const std::vector<vec3f> &pos, float searchRadius, const zeno::LBvh *lbvh, std::vector<std::vector<int>> & list)
{
