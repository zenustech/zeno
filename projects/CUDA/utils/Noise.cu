...
struct PerlinNoise {
    ...
    static constexpr vec3f perlin_hash22(vec3f p) {
    ...
    static constexpr float perlin(vec3f a, float power, float depth) {
        float total = 0;
