...
#define DEFINE_MAT_VEC_TYPE(type, tail)                                                                             \
    ...
    DEFINE_VEC(3, type, tail) DEFINE_VEC(4, type, tail) DEFINE_MAT_WITH_ROWS(1, type, tail)                         \
        DEFINE_MAT_WITH_ROWS(2, type, tail) DEFINE_MAT_WITH_ROWS(3, type, tail) DEFINE_MAT_WITH_ROWS(4, type, tail) \
            DEFINE_SQR_MAT(1, type, tail) DEFINE_SQR_MAT(2, type, tail) DEFINE_SQR_MAT(3, type, tail)               \
                DEFINE_SQR_MAT(4, type, tail)
