...
ZENDEFNODE(PrimitiveUnaryOp, {/* inputs: */ {
                                  "primA",
                                  "primOut",
                              },
                              /* outputs: */
...
struct BinaryOperator {
    ...
    void operator()(std::vector<TOut> &arrOut, std::vector<TA> const &arrA, std::vector<TB> const &arrB) {
...
ZENDEFNODE(PrimitiveBinaryOp, {/* inputs: */ {
                                   "primA",
                                   "primB",
                                   "primOut",
                               },
...
ZENDEFNODE(PrimitiveMix, {/* inputs: */ {
                              "primA",
                              "primB",
                              "primOut",
                              "coef",
...
struct HalfBinaryOperator {
    ...
    template <class TOut, class TA, class TB>
    void operator()(std::vector<TOut> &arrOut, std::vector<TA> const &arrA, TB const &valB) {
        size_t n = std::min(arrOut.size(), arrA.size());
#pragma omp parallel for
        for (int i = 0; i < n; i++) {
...
ZENDEFNODE(PrimitiveHalfBinaryOp, {/* inputs: */ {
                                       "primA",
                                       "valueB",
                                       "primOut",
                                   },
