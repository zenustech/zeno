...
void DockContent_Editor::initToolbar(QHBoxLayout* pToolLayout)
{
    ...
    m_btnLightCamera->setText(tr("LightCamera"));
    ...
    m_btnLightCamera->setTextClr(QColor(Qt::gray), QColor(Qt::gray), QColor("#FFFFFF"), QColor("#FFFFFF"));
...
void DockContent_Editor::initConnections()
{
    ...
    connect(m_btnLightCamera, &ZToolButton::clicked, this, [=]() {
        static bool cacheLightCameraOnly = false;
        QSettings settings(zsCompanyName, zsEditor);
        if (settings.value("zencache-enable").toBool())
        {
            cacheLightCameraOnly = !cacheLightCameraOnly;
            settings.setValue("cacheLightCameraOnly", cacheLightCameraOnly);
            zeno::log_critical("cacheLightCameraOnly: {}", cacheLightCameraOnly ? "On" : "Off");
        }
    });
