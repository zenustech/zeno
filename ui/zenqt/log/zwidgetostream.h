...
class ProxySendThreadLog : public QObject
{
    Q_OBJECT
public:
    ProxySendThreadLog() {}
...
signals:
    void threadlogReady(const QString& msg);
};
...
public:
    ...
    std::shared_ptr<ProxySendThreadLog> threadLogProxy() const;
...
private:
    ...
    std::shared_ptr<ProxySendThreadLog> m_spProxyThreadLog;
};
