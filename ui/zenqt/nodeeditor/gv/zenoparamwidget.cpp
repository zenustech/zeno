...
#include "syntax/zfxsys/zfxhighlighter.h"
...
////////////////////////////////////////////////////////////////////////////////
ZenoParamLineEdit::ZenoParamLineEdit(const QString &text, zeno::ParamControl ctrl, LineEditParam param, QGraphicsItem *parent)
...
//////////////////////////////////////////////////////////////////////////////////////
//code  editor
ZenoParamCodeEditor::ZenoParamCodeEditor(const QString& text, QGraphicsItem* parent /* = nullptr */)
{
    m_pCodeEditor = new ZCodeEditor(text);
    ...
    , m_minView(nullptr)
{
    ...
    m_minMute->setPos(QPointF(0, 0));
    m_minView->setPos(QPointF(ZenoStyle::dpiScaled(28), 0));
...
{
    if (!m_mute->isVisible() && !m_view->isVisible())
    {
        QRectF rc;
