...
void DockContent_Editor::initToolbar(QHBoxLayout* pToolLayout)
{
    ...
    cbZoom = qobject_cast<QComboBox*>(zenoui::createWidget("100%", zeno::Combobox, Param_String, cbSet, props));
...
void DockContent_View::initToolbar(QHBoxLayout* pToolLayout)
{
    ...
    m_cbRes = qobject_cast<QComboBox*>(zenoui::createWidget("Free", zeno::Combobox, Param_String, cbSet, props));
