...
void DockContent_Editor::initToolbar(QHBoxLayout* pToolLayout)
{
    ...
    cbZoom = qobject_cast<QComboBox*>(zenoui::createWidget(QModelIndex(), "100%", zeno::Combobox, zeno::types::gParamType_String, cbSet, props));
...
void DockContent_View::initToolbar(QHBoxLayout* pToolLayout)
{
    ...
    m_cbRes = qobject_cast<QComboBox*>(zenoui::createWidget(QModelIndex(), "Free", zeno::Combobox, zeno::types::gParamType_String, cbSet, props));
