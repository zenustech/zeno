Welcome to use the binary release of ZENO! To play with it, simply extract the `.tar.gz` and run `./start.sh` in it, the node editor window will shows up if everything works.
