...
struct HashTable
{
    ...
    :  table_rank(static_cast<unsigned int>(~0u)), table_bits(static_cast<unsigned int>(~0u)), table(0u), num_entries(static_cast<unsigned int>(~0u)), pool(), free_list(static_cast<unsigned int>(~0u)),
