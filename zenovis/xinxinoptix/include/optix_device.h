...
/// Returns the curve parameter associated with the current intersection
/// when using OptixBuildInputCurveArray objects.
...
/// when using OptixBuildInputCurveArray objects with curveType OPTIX_PRIMITIVE_TYPE_FLAT_QUADRATIC_BSPLINE.
