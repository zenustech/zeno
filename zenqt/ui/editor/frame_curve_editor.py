...
class ChannelsWidget(QGroupBox):
    def __init__(self) -> None:
        super().__init__()
        self.check_x = QRadioButton('x')
        self.check_y = QRadioButton('y')
        self.check_z = QRadioButton('z')
        self.check_w = QRadioButton('w')
        self.label_x = QLabel('{:.3f}'.format(0))
        self.label_y = QLabel('{:.3f}'.format(0))
        self.label_z = QLabel('{:.3f}'.format(0))
        self.label_w = QLabel('{:.3f}'.format(0))
        ...
        self.layout.addWidget(self.check_x, 0, 0)
        self.layout.addWidget(self.check_y, 1, 0)
        self.layout.addWidget(self.check_z, 2, 0)
        self.layout.addWidget(self.check_w, 3, 0)
        self.layout.addWidget(self.label_x, 0, 1)
        self.layout.addWidget(self.label_y, 1, 1)
        self.layout.addWidget(self.label_z, 2, 1)
        self.layout.addWidget(self.label_w, 3, 1)
...
class CurveWindow(QWidget):
    ...
    def bind(self):
        ...
        self.left_column.channels_widget.check_x.clicked.connect(lambda : self.widget_state.set_sel_channel('x'))
        self.left_column.channels_widget.check_y.clicked.connect(lambda : self.widget_state.set_sel_channel('y'))
        self.left_column.channels_widget.check_z.clicked.connect(lambda : self.widget_state.set_sel_channel('z'))
        self.left_column.channels_widget.check_w.clicked.connect(lambda : self.widget_state.set_sel_channel('w'))
