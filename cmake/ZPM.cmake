...
function (_zpm_install pkg_desc)
    ...
    execute_process(
        COMMAND ${CMAKE_COMMAND} -G ${CMAKE_GENERATOR} -Wno-dev -S ${pkg_path} -B ${PROJECT_BINARY_DIR}/zpm_pkg_build/${pkg_path} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${ZPM_INSTALL_PREFIX} -DCMAKE_FIND_USE_CMAKE_PATH:BOOL=TRUE -DCMAKE_FIND_USE_CMAKE_SYSTEM_PATH:BOOL=FALSE -DCMAKE_PREFIX_PATH=${ZPM_INSTALL_PREFIX} ${pkg_args}
        RESULT_VARIABLE ret
        )
